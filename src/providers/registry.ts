...
export function providers(): StorageProvider[] {
  return [new GitWorktreeProvider(), new ProjectArtifactProvider(), claudeProvider(), geminiProvider(), clineProvider(), opencodeProvider(), codexProvider(), cursorProvider(), npmProvider(), pnpmProvider()];
}
